...
public interface DbSchema {
	...
	String DELETE_TBL_MENU_GROUP = "DELETE TABLE "+ TBL_MENU_GROUP;
	String DELETE_TBL_MENU_ITEM = "DELETE TABLE "+ TBL_MENU_ITEM;
	String DELETE_TBL_ORDER = "DELETE TABLE "+ TBL_ORDER;
	String DELETE_TBL_ORDER_ITEM = "DELETE TABLE  "+ TBL_ORDER_ITEM;
